...
class Hangman:
    ...
    def check_letter(self, letter):
        ...
        if letter not in self.word and len(letter) == 1:      
            self.num_lives -= 1
        ...
        print(f"Mystery word is {self.word_guessed}. Letters guessed {list(set(self.list_letters))}. You have {self.num_lives} lives remaining.")         
